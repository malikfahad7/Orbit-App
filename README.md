...
### Configuration
- Server .env File: Create a .env file in the server directory with the following variables:
  MONGO_URL=mongodb+srv://your-username:your-password@your-cluster.mongodb.net/Orbit?retryWrites=true&w=majority&appName=Orbit
  CLOUDINARY_CLOUD_NAME=your-cloud-name
  CLOUDINARY_API_KEY=your-api-key
  CLOUDINARY_API_SECRET=your-api-secret
  PORT=3000
  Update these values with your actual MongoDB and Cloudinary credentials.
- Client IP: Ensure the IP in the client code (e.g., http://192.168.1.22:3000/api/alert/${alertId} in App.js) matches your server’s IP.
